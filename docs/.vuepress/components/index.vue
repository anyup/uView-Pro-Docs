<template>
  <div>
    ...
    <div class="main-content container">
      <div class="banner">
        <div class="desc">
          <h1>uni-app Vue3 多平台快速开发的UI框架</h1>
          <h2 class="desc-text">
            uView Pro，是 uni-app 全面兼容 Vue3 的 uni-app
            生态框架，全面的组件和便捷的工具会让您信手拈来，如鱼得水。
          </h2>
          <div class="banner-img">
            <img
              src="https://ik.imagekit.io/anyup/uview-pro/docs/index/banner_1920x1080.png"
            />
          </div>
        </div>
      </div>
      <div class="card-box components">
        ...
        <ul class="row">
          <li class="col-md-3 col-sm-12">
            <div class="card-item">
              <img
                src="https://ik.imagekit.io/anyup/uview-pro/docs/index/guide.png"
              />
              <h3>指南</h3>
              <p>
          ...
          <li class="col-md-3 col-sm-12">
            <div class="card-item">
              <img
                src="https://ik.imagekit.io/anyup/uview-pro/docs/index/components.png"
              />
              <h3>组件</h3>
              <p>
          ...
          <li class="col-md-3 col-sm-12">
            <div class="card-item">
              <img
                src="https://ik.imagekit.io/anyup/uview-pro/docs/index/js.png"
              />
              <h3>工具库</h3>
              <p>
          ...
          <li class="col-md-3 col-sm-12">
            <div class="card-item">
              <img
                src="https://ik.imagekit.io/anyup/uview-pro/docs/index/layout.png"
              />
              <h3>布局</h3>
              <p>
      ...
      <div class="card-box support">
        ...
        <ul class="row">
          <li class="col-md-3 col-sm-6 col-xs-6">
            <div class="card-item">
              <img
                src="https://ik.imagekit.io/anyup/uview-pro/docs/index/android.png"
              />
              <h3>安卓</h3>
          ...
          <li class="col-md-3 col-sm-6 col-xs-6">
            <div class="card-item">
              <img
                src="https://ik.imagekit.io/anyup/uview-pro/docs/index/ios.png"
              />
              <h3>Apple</h3>
          ...
          <li class="col-md-3 col-sm-6 col-xs-6">
            <div class="card-item">
              <img
                src="https://ik.imagekit.io/anyup/uview-pro/docs/index/weixin.png"
              />
              <h3>微信小程序</h3>
          ...
          <li class="col-md-3 col-sm-6 col-xs-6">
            <div class="card-item">
              <img
                src="https://ik.imagekit.io/anyup/uview-pro/docs/index/h5.png"
              />
              <h3>H5</h3>
        ...
        <ul class="row">
          <li class="col-md-3 col-sm-6 col-xs-6">
            <div class="card-item">
              <img
                src="https://ik.imagekit.io/anyup/uview-pro/docs/index/qq.png"
              />
              <h3>QQ小程序</h3>
          ...
          <li class="col-md-3 col-sm-6 col-xs-6">
            <div class="card-item">
              <img
                src="https://ik.imagekit.io/anyup/uview-pro/docs/index/baidu.png"
              />
              <h3>百度小程序</h3>
          ...
          <li class="col-md-3 col-sm-6 col-xs-6">
            <div class="card-item">
              <img
                src="https://ik.imagekit.io/anyup/uview-pro/docs/index/alipay.png"
              />
              <h3>支付宝小程序</h3>
          ...
          <li class="col-md-3 col-sm-6 col-xs-6">
            <div class="card-item">
              <img
                src="https://ik.imagekit.io/anyup/uview-pro/docs/index/toutiao.png"
              />
              <h3>头条小程序</h3>
