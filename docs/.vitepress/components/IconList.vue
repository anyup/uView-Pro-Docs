<template>
	<el-row class="icon-box" :gutter="0">
		<el-col :xs="8" :sm="6" :md="6" :lg="4" :xl="4" v-for="(item, index) in iconList" :key="index">
			<div class="item">
				<i class="iconfont" :class="['uicon-' + item]"></i>
